...
var Grid = (function() {
	...
	function saveItemInfo( saveheight ) {
		$items.each( function() {
			var $item = $( this );
			$item.data( 'offsetTop', $item.offset().top-200 );
			if( saveheight ) {
	...
	function getWinSize() {
		winsize = { width : $window.width(), height : $window.height()-200 };
	}
	...
	Preview.prototype = {
		create : function() {
			...
			this.$twitter = $('<a href="" class="social" target="_blank"><i class="fab fa-twitter"></i></a>');
			this.$facebook = $('<a href="" class="social" target="_blank"><i class="fab fa-facebook-f"></i></a>');
